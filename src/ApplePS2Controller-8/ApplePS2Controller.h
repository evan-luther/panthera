...
private:
  ...
  IOTimerEventSource *     _pollSource;
  ...
  bool                     _interruptRegisteredKeyboard;
  bool                     _interruptRegisteredMouse;
  ...
  virtual void  pollForData(IOTimerEventSource *);
  ...
  static  void  _interruptOccurredAction(OSObject * owner, IOInterruptEventSource * sender, int count);
  static  void  _processRequestQueueAction(OSObject * owner, IOInterruptEventSource * sender, int count);
  static  void  _pollForDataAction(OSObject * owner, IOTimerEventSource * sender);
