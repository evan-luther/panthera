...
static void _doProcessNotificationsTrampoline(thread_call_param_t param0, thread_call_param_t param1)
{
    if (param0) {
        ((IOHIDSystem *)param0)->doProcessNotifications();
    }
}
...
//    require_noerr(workLoop->addEventSource(periodicES), exit_early);
    ...
    _delayedNotificationThread = thread_call_allocate(_doProcessNotificationsTrampoline, this);
