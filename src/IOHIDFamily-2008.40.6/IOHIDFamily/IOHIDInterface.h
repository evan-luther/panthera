...
public:
    ...
    virtual void ReportAvailable(uint64_t timestamp,
                                 ...
                                 IOMemoryDescriptor *report,
                                 OSAction *action,
                                 OSDispatchMethod actionDispatch = NULL);
    virtual kern_return_t AddReportToPool_Impl(IOHIDInterface_AddReportToPool_Args);
    virtual kern_return_t Open_Impl(IOHIDInterface_Open_Args);
    virtual kern_return_t Close_Impl(IOHIDInterface_Close_Args);
    virtual kern_return_t SetReport_Impl(IOHIDInterface_SetReport_Args);
    virtual kern_return_t GetReport_Impl(IOHIDInterface_GetReport_Args);
    virtual kern_return_t GetSupportedCookies_Impl(IOHIDInterface_GetSupportedCookies_Args);
    virtual kern_return_t SetElementValues_Impl(IOHIDInterface_SetElementValues_Args);
    virtual kern_return_t GetElementValues_Impl(IOHIDInterface_GetElementValues_Args);
    virtual kern_return_t SendDebugBuffer_Impl(IOHIDInterface_SendDebugBuffer_Args);
};
