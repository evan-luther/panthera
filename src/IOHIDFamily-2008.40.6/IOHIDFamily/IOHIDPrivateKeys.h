...
#define kIOHIDDeviceGameControllerSupportKey "GameControllerSupport"
...
#define kIOHIDDevicePrivilegedKey           "DevicePrivileged"
#define kIOHIDDeviceMessagePropertyUpdateKeys kIOHIDBatchIntervalKey, kIOHIDRequestTimeoutKey, kIOHIDReportIntervalKey
#define kIOHIDDeviceForceInterfaceRematchKey "DeviceForceInterfaceRematch"
#define kIOHIDDKStartKey                    "DKStart"
#define kIOHIDPropagatePropertyKeys         "PropagatePropertyKeys"

enum {
    kIOHIDOptionsPrivateTypeNoDroppedReports  = 0x1 << 16,
    kIOHIDOptionsPrivateTypeIgnoreTaskSuspend = 0x2 << 16,
};
