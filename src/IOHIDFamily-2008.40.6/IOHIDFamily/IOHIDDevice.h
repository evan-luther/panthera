...
#endif
{
    ...
    friend void _runSyncReportAsyncTrampoline(thread_call_param_t param0, thread_call_param_t param1);
    friend void _setNextAsyncTimeoutTrampoline(OSObject *owner, IOTimerEventSource *sender);
...
protected:
    ...
    virtual kern_return_t _Start_Impl(IOHIDDevice__Start_Args);
    virtual void _SetProperty_Impl(IOHIDDevice__SetProperty_Args);
    virtual void _ProcessReport_Impl(IOHIDDevice__ProcessReport_Args);
    virtual kern_return_t _HandleReport_Impl(IOHIDDevice__HandleReport_Args);
    virtual void _CompleteReport_Impl(IOHIDDevice__CompleteReport_Args);
