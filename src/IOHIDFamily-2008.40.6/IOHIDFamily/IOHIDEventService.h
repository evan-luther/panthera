...
public:
    ...
    virtual kern_return_t Start_Impl(IOHIDEventService_Start_Args);
    virtual kern_return_t Stop_Impl(IOHIDEventService_Stop_Args);
    virtual kern_return_t _Start_Impl(IOHIDEventService__Start_Args);
    virtual kern_return_t _DispatchKeyboardEvent_Impl(IOHIDEventService__DispatchKeyboardEvent_Args);
    virtual kern_return_t _DispatchRelativePointerEvent_Impl(IOHIDEventService__DispatchRelativePointerEvent_Args);
    virtual kern_return_t _DispatchAbsolutePointerEvent_Impl(IOHIDEventService__DispatchAbsolutePointerEvent_Args);
    virtual kern_return_t _DispatchRelativeScrollWheelEvent_Impl(IOHIDEventService__DispatchRelativeScrollWheelEvent_Args);
    virtual void SetLED_Impl(IOHIDEventService_SetLED_Args);
    virtual kern_return_t SetEventMemory_Impl(IOHIDEventService_SetEventMemory_Args);
    virtual kern_return_t EventAvailable_Impl(IOHIDEventService_EventAvailable_Args);
    virtual void _CopyEvent_Impl(IOHIDEventService__CopyEvent_Args);
    virtual void _CompleteCopyEvent_Impl(IOHIDEventService__CompleteCopyEvent_Args);
    virtual kern_return_t handleCopyMatchingEvent_Impl(IOHIDEventService_handleCopyMatchingEvent_Args);
    virtual kern_return_t SetProperties_Impl(IOHIDEventService_SetProperties_Args);
    virtual void _SetUserProperties_Impl(IOHIDEventService__SetUserProperties_Args);
    virtual void _CompleteSetProperties_Impl(IOHIDEventService__CompleteSetProperties_Args);
    virtual void _SetLED_Impl(IOHIDEventService__SetLED_Args);
    virtual kern_return_t SetLEDState_Impl(IOHIDEventService_SetLEDState_Args);
    virtual void _CompleteSetLED_Impl(IOHIDEventService__CompleteSetLED_Args);
