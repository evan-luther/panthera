...
/*
 * Later IOHIDFamily sources classify some devices with type-hint properties.
 * Panthera only needs the symbols to exist so newer HID services compile and
 * publish stable properties during bring-up.
 */
