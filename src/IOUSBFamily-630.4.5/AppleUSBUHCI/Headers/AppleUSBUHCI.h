...
enum : uint64_t {
    kUHCIErrataDontUseCompanionController      = (1ULL << 0),
    kUHCIErratakUHCIResetAfterBabble           = (1ULL << 1),
    kUHCIErrataICH6PowerSequencing             = (1ULL << 2),
    kUHCIErrataSupportsPortResumeEnable        = (1ULL << 3),
    kUHCIErrataUHCISupportsOvercurrent         = (1ULL << 4),
    kUHCIErrataUHCISupportsResumeDetectOnConnect = (1ULL << 5)
};
