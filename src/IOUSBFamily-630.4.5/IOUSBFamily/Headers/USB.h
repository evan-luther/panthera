...
#ifndef USBBitRange
#define USBBitRange(start, end) (((UInt32)~0U >> (31 - ((end) - (start)))) << (start))
#endif

#ifndef USBBitRangePhase
#define USBBitRangePhase(start, end) (start)
#endif
...
typedef UInt32 USBPhysicalAddress32;
...
#define kIOUSBTooManyTransactionsPending	iokit_usb_err(0x42)	// Request would exceed the allowed number of pending transactions
#define kIOUSBStreamsNotSupported		iokit_usb_err(0x44)	// Controller does not support USB streams
#define kIOUSBDeviceCountExceeded		iokit_usb_err(0x45)	// Controller does not support more devices
#define kIOUSBEndpointCountExceeded		iokit_usb_err(0x46)	// Controller does not support more endpoints
#define kIOUSBInvalidSSEndpoint         iokit_usb_err(0x43) // SuperSpeed endpoint is invalid
#define kIOUSBDevicePortWasNotSuspended		iokit_usb_err(0x47)	// Port was not suspended
#define kIOUSBClearPipeStallNotRecursive	iokit_usb_err(0x48)	// ClearPipeStall should not be called recursively
#define kIOUSBDeviceTransferredToCompanion	iokit_usb_err(0x49)	// Device transferred to another controller
#define kIOUSBSyncRequestOnWLThread		iokit_usb_err(0x4a)	// Synchronous request issued from the workloop thread
#define kIOUSBHighSpeedSplitError		iokit_usb_err(0x4b)	// Error to hub on high speed bus trying to do split transaction
...
enum {
    ...
    kIOUSBInterfaceOpenAlternateInterfaceMask	= (1U << kIOUSBInterfaceOpenAlternateInterfaceBit),
    kUSBOptionBitOpenExclusivelyMask		= (1U << kUSBOptionBitOpenExclusivelyBit)
};
...
enum {
    kUSBSpeed_Mask  = 0x0003,
    kUSBSpeed_Shift = 0,
    kUSBAddress_Mask  = 0xFF00,
    kUSBAddress_Shift = 8
};
...
enum {
        ...
        kUSBDeviceSpeedSuper		= 3		// SuperSpeed device
        };
...
#define kUSBDeviceResumeRecoveryTime		"kUSBResumeRecoveryTime"
...
typedef enum
{
    ...
    kUSBAddExtraResetTimeMask		= (1U << kUSBAddExtraResetTimeBit)
