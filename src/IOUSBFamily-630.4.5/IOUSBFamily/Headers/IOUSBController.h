...
enum {
    ...
    kErrataNeedsWatchdogTimer					= (1 << 6),
    kErrataNeedsPortPowerOff					= (1 << 7),
    kErrataAgereEHCIAsyncSched					= (1 << 8),
    kErrataNECOHCIIsochWraparound				= (1 << 9),
    kErrataNECIncompleteWrite					= (1 << 10),
    kErrataICH6PowerSequencing					= (1 << 11),
    kErrataICH7ISTBuffer						= (1 << 12),
    kErrataUHCISupportsOvercurrent				= (1 << 13),
    kErrataNeedsOvercurrentDebounce				= (1 << 14),
    kErrataSupportsPortResumeEnable				= (1 << 15),
    kErrataNoCSonSplitIsoch						= (1 << 16),
    kErrataOHCINoGlobalSuspendOnSleep			= (1 << 17),
    kErrataMissingPortChangeInt					= (1 << 18),
    kErrataMCP79IgnoreDisconnect				= (1 << 19),
    kErrataUse32bitEHCI							= (1 << 20),
    kErrataUHCISupportsResumeDetectOnConnect	= (1 << 21),
    kErrataDontUseCompanionController			= (1 << 22),
    kErrataIgnoreRootHubPowerClearFeature		= (1 << 23),
    kErrataDisablePCIeLinkOnSleep				= (1 << 24),
    kErrataEHCIUseRLvalue                       = (1 << 26)
};
...
protected:
	...
	IOCommandPool		*freeUSBIsocCommandPool;
        ...
        SInt32			_activeIsochTransfers;
        IOService *		_provider;
        bool			_controllerCanSleep;
        bool			_needToClose;
        UInt32			_isochMaxBusStall;
        SInt32			_activeInterruptTransfers;
...
#define _rootHubDeviceSS		_expansionData->_rootHubDeviceSS
    ...
    IOReturn                    CheckForDisjointDescriptor(IOUSBCommand *command, UInt16 maxPacketSize);
...
{
public:
	IOUSBController_ExtraCurrentIOLockClass(void);
	virtual ~IOUSBController_ExtraCurrentIOLockClass(void);
...
enum
{
    kPCIPMRegBlockCapID = 0,
    kPCIPMRegBlockNext  = 1,
    kPCIPMRegBlockPMC   = 2,
    kPCIPMRegBlockPMCSR = 4,
    kPCIPMRegBlock_BSE  = 6,
    kPCIPMRegBlockData  = 7
};
