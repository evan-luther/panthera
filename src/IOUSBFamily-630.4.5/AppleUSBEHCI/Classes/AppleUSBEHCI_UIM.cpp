...
mungeECHIStatus(UInt32 flags, EHCIGeneralTransferDescriptorPtr pHCDoneTD, uintptr_t hc, UInt32 busNumber )
{
	...
	{
		USBTrace( kUSBTEHCI, kTPEHCIMungeEHCIStatus, hc, flags, busNumber, 1);
	}
	...
	USBTrace( kUSBTEHCI, kTPEHCIMungeEHCIStatus , hc, flags, kOHCIITDConditionCRC, 0);
...
{
    static const IOReturn statusToErrorMap[] = {
