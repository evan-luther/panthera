/*
 * Copyright й 1998-2013 Apple Inc.  All rights reserved.
 * 
...
#ifndef kUSBExpressCardCantWake
#define kUSBExpressCardCantWake "USBExpressCardCantWake"
#endif

#ifndef kUSBSuspendPort
#define kUSBSuspendPort "USBSuspendPort"
#endif
...
IOUSBCompositeDriver::ConfigureDevice()
{
   ...
   // Find if we have a Preferred Configuration
	...
	if ( fDevice->getProperty(kUSBExpressCardCantWake) == kOSBooleanTrue )
	{
		...
		fDevice->GetBus()->messageClient(kIOUSBMessageExpressCardCantWake, this, fDevice);
