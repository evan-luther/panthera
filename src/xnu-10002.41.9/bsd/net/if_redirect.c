...
{
	(void)&redirect_cloner;
	/*
	 * Panthera doesn't currently exercise this optional redirect-netif path,
	 * and under QEMU bring-up it can receive nexus callbacks with a NULL
	 * provider context before the rest of networking is stable.
	 * Defer this subsystem until the base network stack is booting cleanly.
	 */
	return;
}
