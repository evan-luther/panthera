...
coalitions_init(void)
{
	...
	panthera_debugcon_puts("PANTHERA:COAL_A\n");
	smr_hash_init(&coalition_hash, COALITION_HASH_SIZE_MIN);

	panthera_debugcon_puts("PANTHERA:COAL_B\n");
	init_task_ledgers();

	panthera_debugcon_puts("PANTHERA:COAL_C\n");
	init_coalition_ledgers();
	panthera_debugcon_puts("PANTHERA:COAL_D\n");
