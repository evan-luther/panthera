...
#endif
#ifndef PANTHERA_PRINTF
#define PANTHERA_PRINTF(...) PANTHERA_TRACE(printf(__VA_ARGS__))
#endif
#ifndef PANTHERA_KPRINTF
#define PANTHERA_KPRINTF(...) PANTHERA_TRACE(kprintf(__VA_ARGS__))
#endif
#endif
