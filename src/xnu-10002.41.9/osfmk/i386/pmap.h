...
#ifndef NKPT
/*
 * Panthera: increased from 500 to 1024 for systems with large physical memory.
 * With 6GB+ RAM, first_avail lands near 1GB into kernel VA space, and early
 * allocations (pmap_struct ~50MB, zone maps, etc.) push past 500 PTs' 1GB limit.
 * 1024 PTs cover 2GB of kernel VA, matching what iBoot provides on real hardware.
 */
#define NKPT            4096
#endif
