...
static volatile int commpage_ready = 0; // set after commpage_populate_one() completes for all commpages
...
commpage_populate( void )
{
	...
	commpage_ready = 1; // enable async commpage updates now that backing PTEs are stable
