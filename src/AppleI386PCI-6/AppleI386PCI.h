...
class AppleI386PCI : public IOPCIHostBridge
{
...
public:
    ...
    virtual void configWrite8( IOPCIAddressSpace space,
					UInt8 offset, UInt8 data );
    virtual IOReturn setLinkSpeed( tIOPCILinkSpeed linkSpeed, bool retrain );
    virtual IOReturn getLinkSpeed( tIOPCILinkSpeed * linkSpeed );
};
