...
OBJDIR="${BUILDDIR}/obj/libsystem_sandbox"
SOURCESDIR="${BUILDDIR}/sources"
SYSROOT="${BUILDDIR}/sysroot"
OUTDIR="${SYSROOT}/usr/lib/system"
OUT="${OUTDIR}/libsystem_sandbox.dylib"
DYLD_STUB="${BUILDDIR}/obj/dyld_stub_binder.o"
SDK_PATH="$(xcrun -sdk macosx --show-sdk-path)"
CC="$(xcrun -sdk macosx -find clang)"
TARGET="x86_64-apple-darwin23.0"

SRC="${SOURCESDIR}/libsystem_sandbox_stub.c"
OBJ="${OBJDIR}/libsystem_sandbox_stub.o"
...
echo ">>> Building libsystem_sandbox"

"${CC}" "${COMMON_FLAGS[@]}" \
    -c "${SRC}" -o "${OBJ}"

xcrun ld -arch x86_64 -dylib \
    -install_name /usr/lib/system/libsystem_sandbox.dylib \
