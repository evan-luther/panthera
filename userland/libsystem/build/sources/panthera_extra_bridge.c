...
struct __panthera_double2 {
    double __sinval;
    double __cosval;
};

struct __panthera_double2 panthera_sincos_stret(double x) __asm__("___sincos_stret");
struct __panthera_double2 panthera_sincos_stret(double x) {
    volatile double vx = x;
    struct __panthera_double2 r;
    r.__sinval = sin(vx);
    r.__cosval = cos(vx);
    return r;
}
